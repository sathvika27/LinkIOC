...
/* Generated from ../O.Common/linkIOC.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_dbrestoreRegister, pvar_func_save_restoreRegister,
...
int linkIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/repos/linkIOC";
...
/* linkIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"linkIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    linkIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
